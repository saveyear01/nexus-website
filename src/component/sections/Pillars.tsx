        ...
        <section className="px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="mt-10 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                {PILLARS.map(({ icon: Icon, title, body }) => (
                    <div
                        key={title}
                        className="group relative p-8 rounded-[2rem] bg-white hover:bg-[#062365] hover:text-white transition-colors duration-300"
                    >
                        <div className="h-12 w-12 rounded-full bg-[#D4DAE9] text-[#062365] group-hover:bg-white grid place-items-center">
                            <Icon size={22} />
                        </div>
